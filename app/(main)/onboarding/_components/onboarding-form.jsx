    ...
    <div className="flex items-center justify-center bg-background">
      <Card className="w-full max-w-lg mt-10 mx-2">
        <CardHeader>
          ...
          <CardDescription>
            Select your industry to get personalized carer insight and
            recommendations.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-5">
              ...
              >
                ...
                <SelectContent className="duration-300 ease-in">
                  {industries.map((ind) => {
                    return (
            ...
            <div className="space-y-5">
              ...
              <Textarea
                placeholder="Text us about your professional background..."
                className="h-32"
                {...register("bio")}
              />

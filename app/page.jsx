...
export default function Home() {
  return (
    <div>
          ...
          mx-auto">
            {features.map((features, index) => {
              return (
                <Card
                  key={index}
                  className="border-2 hover:border-primary hover:translate-y-[-5%] transition-all duration-300 ease-in">
      ...
      <section className="w-full py-12 mb-6 md:py-24 lg:py-32 bg-muted/50">
        <div className="container mx-auto px-4 md:px-6">
                    ...
                    <div className="flex flex-col space-y-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="tex-sm text-muted-foreground">{testimonial.role}</p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-6xl mx-auto">
            <Accordion type="single" collapsible className="w-full">
              {faqs.map((faq, index) => {
                return (
                  <AccordionItem key={index} value={`itme-${index}`}>
      ...
      <section className="w-full">
        <div className="mx-auto py-24 bg-foreground rounded-lg">
